...
export default function PomodoroTimer() {
  ...
  return (
    <>
      <Helmet>
        <title>Pizone: Pomodoro Timer, Stopwatch, & Custom Focus Sessions</title>
        <meta name="description" content="Boost focus with the Pizone Pomodoro Timer. Use structured work sessions (25, 35, 45 min), a custom timer, and a built-in stopwatch to maximize study efficiency." />
      </Helmet>
      <Navbar/>
